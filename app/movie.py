...
def format_vote_average(pick_vote_average):
    try:
        ...
        vote_average = "You entered an invalid value for the Minimum Movie Rating. Please try again."
        print(vote_average)
        quit()
    return vote_average
...
def format_runtime_min(pick_runtime_min):
    try:
        ...
        #runtime_min = "You entered an invalid value for the Minimum Runtime. Please try again"
